...
con_string = "mongodb+srv://manwin:manwin@cluster0.q3zx5wu.mongodb.net/?retryWrites=true&w=majority"

client = pymongo.MongoClient(con_string)

db = client.get_database('testdb')

user_collection = pymongo.collection.Collection(db, 'users') #(<database_name>,"<collection_name>")
